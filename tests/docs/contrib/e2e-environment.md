...
| {CORE \| JAVA \| JAVASCRIPT \| GO}_VSIX_FILE_PATH    | (Optional) Path to the extension in vsix format. <br/>If this and CORE_VSIX_DOWNLOAD_URL are not set, the tests will run using the local extension under development (launches VS Code with `--extensionDevelopmentPath` and `--enable-proposed-api`). |
| {CORE \| JAVA \| JAVASCRIPT \| GO}_VSIX_DOWNLOAD_URL | (Optional) URL to get core vsix from (only used if {CORE \| JAVA \| JAVASCRIT}_VSIX_FILE_PATH is not defined)                                                                                                                                          |
...
| HUB_URL                                              | URL of the Konveyor hub instance                                                                                                                                                                                                                       |
| HUB_AUTH_ENABLED                                     | (Optional, boolean) Default is `false`                                                                                                                                                                                                                 |
| HUB_USERNAME                                         | Username for hub authentication                                                                                                                                                                                                                        |
| HUB_PASSWORD                                         | Password for hub authentication                                                                                                                                                                                                                        |
| HUB_INSECURE                                         | (Optional, boolean) When set to `true`, disables TLS certificate validation.                                                                                                                                                                           |
